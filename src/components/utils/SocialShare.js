...
const SocialShare = ({ title, link }) => {
  ...
  return (
    <Share>
      <span>Share</span>
      <a
        href={`mailto:?subject=Check this article from Friesland School&amp;body=Check out this article at ${link}`}
        title="Share by Email"
      >
        <FontAwesomeIcon icon={faEnvelope} />
      </a>
      <a
        href={`https://twitter.com/intent/tweet?text=${twitterStart}${twitterTitle}%20${link}`}
